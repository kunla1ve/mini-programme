...
"""
1 亿次试验、90% 置信度下，估计 p = 3.5 × 10^(-6) 的相对误差约为 ±8.8%。
95% 置信度 → 相对误差约 10.5%

1 亿次试验、90% 置信度下，估计 p = 3.93 × 10^(-6) 的相对误差约为 ±8.3%。

=== m=12 张软炸 ===
  地主概率: 0.00000393 (0.0004%)
  单个农民概率: 0.00000022 (0.0000%)
  两个农民都有: 0.00000000 (0.0000%)
  地主+任一农民: 0.00000000 (0.0000%)
  三方都有: 0.00000000 (0.0000%)
  ★ 总牌局至少一方有: 0.00000426 (0.0004%)
"""
